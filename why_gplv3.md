...
If you'd like to learn more about upgrading your project to GPLv3, the FSF Compliance Lab would be happy to assist you. Both on [gnu.org](https://www.gnu.org/licenses/licenses.html) and [fsf.org](https://www.fsf.org/licensing/), you can find [basic instructions for using the license](https://www.gnu.org/licenses/gpl-howto.html), and a [FAQ addressing common concerns](https://www.gnu.org/licenses/gpl-faq.html) that people have about it. If your situation is more complicated than that, please [contact us](mailto:licensing@fsf.org) and we'll do what we can to help you with your transition. Together, we can help protect freedom for all users.
